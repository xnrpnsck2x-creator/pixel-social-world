...
ARTIFACT_DIR="${PSW_H5_MAP_PATROL_ARTIFACT_DIR:-$ROOT_DIR/.tools/h5-map-patrol}"
...
PSW_H5_SEMANTIC_GROUP=maps \
node "$ROOT_DIR/tests/h5_semantic_smoke.mjs"

node "$ROOT_DIR/tests/h5_map_patrol_report.mjs" "$ARTIFACT_DIR/h5-matrix.json"
