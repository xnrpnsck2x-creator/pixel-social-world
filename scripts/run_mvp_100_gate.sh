...
run_step "Godot creator runtime revocation smoke" run_godot_smoke "$ROOT_DIR/tests/creator_runtime_revocation_smoke.gd"
run_step "Godot declarative minigame smoke" run_godot_smoke "$ROOT_DIR/tests/declarative_minigame_smoke.gd"
