...
- Android runtime budget gate v1 validates the 240-second render-throttle report and the 600-second soak report. The 600-second soak evidence is under `.tools/android-stability-soak-v1/` and passed with 36 samples, 20.8% average CPU, 341.5 MB peak PSS, and -30.2 MB PSS growth.
